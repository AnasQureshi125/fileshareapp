...
function UploadForm({ uploadBtnClick, progress }) {
  ...
  const onFileSelect = (file) => {
    ...
    if (file && file.size > 2000000) {
      setErrorMsg("Maximum Upload File Size is 2 MB");
      return;
    }
    setFile(file);
  };
    ...
    <div className="text-center">
      <div className="flex items-center justify-center w-full">
        <label
          ...
          className="flex flex-col items-center justify-center w-full h-72 border-2 border-blue-300 border-dashed rounded-lg cursor-pointer bg-blue-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600"
        >
